...
class COCODemo(object):
    ...
    def run_on_opencv_image(self, images):
        """
        Arguments:
            images (List of np.ndarray): two images as returned by OpenCV
    ...
    def compute_prediction(self, original_images):
        """
        Arguments:
            original_images (List of np.ndarray): List of images as returned by OpenCV
...
if __name__ == '__main__':
    ...
    cfg.MODEL.WEIGHT = "../model_final.pth"
    # COCOdemo object
    coco_demo = COCODemo(
        cfg,
        min_image_size=720,
    ...
    image_2 = cv2.imread('frame_11.jpg')
